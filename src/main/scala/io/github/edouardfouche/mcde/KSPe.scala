...
/**
  ...
  * This is like KSPemr but does not have marginal restriction (beta parameter is not used)
  *
  ...
  */
case class KSPe(M: Int = 50, alpha: Double = 0.5, beta: Double = 0.5, var parallelize: Int = 0) extends McdeStats {
  type I = I_Rank
  type D = D_Rank
  val id = "KSPe"
