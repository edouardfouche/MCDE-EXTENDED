...
// insert, ties
print(s"A - Check insert below delete for ties")
...
print(s"A - Check insert after delete for ties")
val ties3 = new D_Rank_Stream(tiesA)
ties3.insert(2.5)
assert(ties3(4).toTuple == (5,2.5,0.0))

print(s"A - Check insert middle for ties")
...
print(s"B - Check insert below delete for ties")
...
print(s"B - Check insert after delete for ties")
val ties6 = new D_Rank_Stream(tiesB)
ties6.insert(2.5)
assert(ties6(3).toTuple == (5,2.5,0.0))

print(s"B - Check insert middle for ties")
...
print(s"C - Check insert below delete for ties")
...
print(s"C - Check insert after delete for ties")
val ties9 = new D_Rank_Stream(tiesC)
ties9.insert(2.5)
assert(ties9(4).toTuple == (5,2.5,0.0))

print(s"C - Check insert middle for ties")
